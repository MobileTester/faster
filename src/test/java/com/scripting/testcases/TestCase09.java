...
public class TestCase09 extends UIAutomationBaseTestClass {
	...
	public void method01_Search(TestCase01Testdatum testdatum) {
		...
		Assert.assertNotNull(swagLabsScenario.s_GetLoginUserNames("https://www.saucedemo.com/"), "Getting Usernames Failed");
