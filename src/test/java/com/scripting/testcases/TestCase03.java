...
public class TestCase03 extends UIAutomationBaseTestClass {
	...
	public void method01_Search(TestCase01Testdatum testdatum) {
		...
		assertTrue(googleSearchScenario.s_PerfromGoogleSearch2(testdatum.getGoogleURL(), testdatum.getSearchTerm()), "Search Operation Failed");
