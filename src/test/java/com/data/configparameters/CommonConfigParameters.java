package com.data.configparameters;
...
/** This class path is referenced in pom.xml
 * If the package is changed, updated pom.xml also  */
public final class CommonConfigParameters {
