...
public class EventHandler_Firefox implements WebDriverEventListener {

	private Logger logger = LogManager.getLogger(EventHandler_Firefox.class.getName());
	...
	public boolean jsScrollToAWebElement(By by, WebDriver driver) {
		...
		try {
			...
			cor.inViewPort();
			// 23 Jan 2020 - This scroll will only work in Firefox
