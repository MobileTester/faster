...
public final class EventHandlerForWeb implements WebDriverListener {

	private Logger logger = LogManager.getLogger(EventHandlerForWeb.class.getName());
